...
function App() {
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/najwa1.png" className="w-10 rounded-md" />
              <q>make it happen</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Najwa Aulia Syakila" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="A passionate Network Engineer and student leader, serving as OSIS President while dedicated to building reliable and innovative network infrastructures."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a 
                href="./assets/CV.pdf" 
                download="Najwa_Aulia_Syakila_CV.pdf" 
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I'm Najwa Aulia Syakila, a student at SMKN 1 Cikarang Utara who serves as OSIS President. Beyond leadership, I have a passion for sketching and coloring artwork, and I work as a video editor handling various creative projects. I believe in blending creativity and dedication in everything I do."
                  delay={150}
                  animateBy="words"
                  direction="top"
  ...
  <ChatRoom />
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/najwasyakila821@gmail.com"
                method="POST"
